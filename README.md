### Prescript automates the creation and configuration of a server, then remotely runs a Python script on it. Ideal for many API requests or ML model training.
