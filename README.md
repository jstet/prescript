### Prescript automates the creation and configuration of a server, then automatically runs a Python script on it. Ideal for many API requests or ML model training.
